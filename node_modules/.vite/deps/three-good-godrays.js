...
// node_modules/three-good-godrays/build/three-good-godrays.esm.js
...
var BilateralFilterMaterial = class extends ShaderMaterial {
  constructor(input) {
    super({
      uniforms: {
        tInput: { value: input },
...
var GodraysCompositorMaterial = class extends ShaderMaterial {
  constructor({
    godrays,
    edgeStrength,
    edgeRadius,
...
var GodraysCompositorPass = class extends Pass {
  constructor(props) {
  ...
  render(renderer, inputBuffer, outputBuffer, _deltaTime, _stencilTest) {
    ...
    if (sceneDepth && outputBuffer && sceneDepth === outputBuffer.depthTexture) {
      if (!this.depthCopyRenderTexture) {
        this.depthCopyRenderTexture = new WebGLRenderTarget(
...
var GodraysMaterial = class extends ShaderMaterial {
  constructor(light) {
    const uniforms = {
      ...
      resolution: { value: new Vector2(1, 1) },
      premultipliedLightCameraMatrix: { value: new Matrix4() },
      ...
      fNormals: { value: DIRECTIONS.map(() => new Vector3()) },
...
var PLANES = DIRECTIONS.map(() => new Plane());
var SCRATCH_VECTOR = new Vector3();
var SCRATCH_FRUSTUM = new Frustum();
var SCRATCH_MAT4 = new Matrix4();
var GodraysIllumPass = class extends Pass {
...
var populateParams = (partialParams) => {
  ...
  return {
    ...defaultParams,
    ...partialParams,
    color: new Color((_a = partialParams.color) != null ? _a : defaultParams.color)
  };
};
...
var GodraysPass = class extends Pass {
  /**
  ...
  maybeInitBlur(input) {
    ...
    if (!this.blurRenderTarget) {
      this.blurRenderTarget = new WebGLRenderTarget(
...
//# sourceMappingURL=three-good-godrays.js.map
